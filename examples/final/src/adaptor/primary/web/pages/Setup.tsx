...
import { buttonClassName, ErrorSummary, FormField } from "@moonbase/base-web";
...
export default function Setup({ errors }: SharedPageProps) {
  ...
  return (
    <Layout title="最初のシステム担当を登録">
      <section className="auth-shell">
        <div className="auth-card">
          <p className="auth-card__brand">MoonBase 日の出基地</p>
          <p>最初の一人だけが、この画面から Admin（システム担当）を登録できます。</p>
          <form
            aria-label="初期管理者登録"
