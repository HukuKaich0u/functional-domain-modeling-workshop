...
import type { EvaApproved } from "./evaApproved.js";
import type {
  AbortReason,
  Aborted,
  Approved,
...
export const EvaPermit = {
  approve:
    ...
    (permit: Requested, input: ApproveInput): EvaApproved => {
      const aggregateState = approve(permit, input, context.occurredAt);
