...
test("Session 05 closes a production SQLite owner exactly once", () => {
...
test("Session 05 closes a replaced development SQLite owner without closing its replacement", () => {
  const exits = new EventEmitter();
